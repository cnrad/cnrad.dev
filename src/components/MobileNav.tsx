...
export const MobileNav = () => {
  ...
  return (
    <>
      <motion.div
        layout
        className="font-karla text-tertiary border-tertiary/15 fixed bottom-4 left-1/2 z-100 w-min -translate-x-1/2 rounded-full border bg-white p-1.5 text-sm shadow-xl shadow-black/5 sm:hidden"
      >
